...
object OperationsImpl {
  ...
  def division(input1ByUser:Double, input2ByUser:Double):AnyVal= input1ByUser / input2ByUser
  ...
  def modulus(input1ByUser:Double, input2ByUser:Double):Double= input1ByUser % input2ByUser
